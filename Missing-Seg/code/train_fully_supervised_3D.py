...
import os
# os.environ['CUDA_VISIBLE_DEVICES'] = '3,1'  # Use GPU 1
...
parser.add_argument('--exp', type=str,
                    default='BraTs_Supervised_100', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    # pretrained_model_path = '/home/qitam/sdb2/home/qiteam_project/huang/SSL4MIS-master/model/BraTs2019_Fully_Supervised_4encoder/unet_3D_multi/iter_6600_dice_0.8864.pth'
    ...
    for epoch_num in iterator:
        ...
        # outputs_soft = outputs_soft.to('cpu')
        ...
        # loss_ce = ce_loss(outputs, label_batch)
            ...
            # stacked_loss = torch.stack(loss_list, dim=0)
            # ttloss = torch.mean(stacked_loss, dim=0)
            #
            # # loss = 0.5 * (loss_dice + loss_ce)
            # loss = ttloss
            optimizer.zero_grad()
            ...
            if iter_num > 10000 and iter_num % 2000 == 0:
                model.eval()
