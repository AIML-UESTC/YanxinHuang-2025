...
if __name__ == '__main__':
    ...
    parser.add_argument(
            "--data_path",
            type=str,
            default="/home/qitam/sdc1/MICCAI/home2/Raw_data/MICCAIChallenge2024/ChallengeData/MultiCoil",
    ...
    split_train_val(cine_h5_folder, train_num=20)
    split_train_val(mapping_h5_folder, train_num=20)
